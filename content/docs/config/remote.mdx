...
<Cards>
  <Card title="Local provider" href="/docs/guide/providers/local" description="Serve bundles from disk for development and testing." />
  <Card title="AWS provider" href="/docs/guide/providers/aws" description="S3 + CloudFront, with optional KMS signing." />
  <Card title="Cloudflare provider" href="/docs/guide/providers/cloudflare" description="R2 storage with a Workers handler." />
</Cards>
...
but not JWK. See [Remote bundles](/docs/guide/remote-bundles) for verification and the
[Node API reference](/docs/references/node) for the client-side helpers.
</Callout>
