...
<Cards>
  <Card title="Electron" href="/docs/guides/electron" description="Serve a bundle through a custom protocol in an Electron app." />
  <Card title="Tauri" href="/docs/guides/tauri" description="Add the wvb-tauri plugin to a Tauri v2 app." />
  <Card title="Android" href="/docs/guides/android" description="Serve a WebView from a bundle with the Kotlin bindings." />
  <Card title="iOS" href="/docs/guides/ios" description="Serve a WKWebView from a bundle with the Swift bindings." />
</Cards>
