...
For the OTA concepts behind these commands, see [Remote bundles](/docs/guide/over-the-air). For the native updater the bridge calls into, see the [Node updater API](/docs/references/javascript/node/updater). For the bridge as a whole, see the [Bridge overview](/docs/references/javascript/bridge).
