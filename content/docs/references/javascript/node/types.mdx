...
<Cards>
  <Card
    ...
    description="Overview of @wvb/node and the classes that use these types."
  />
  <Card
    title="BundleSource"
    href="/docs/references/javascript/node/source"
    description="Returns BundleSourceVersion, ListBundleItem, and BundleManifestMetadata."
  />
  <Card
    title="Updater"
    href="/docs/references/javascript/node/updater"
    description="Accepts UpdaterOptions and returns BundleUpdateInfo."
  />
  <Card
    title="Remote & signature config"
    href="/docs/references/configuration/remote"
    description="Configure integrity policy and signing in wvb.config."
  />
</Cards>
