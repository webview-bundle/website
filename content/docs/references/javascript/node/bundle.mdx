...
For the full package surface — sources, protocols, the remote client, and the updater — see the [Node API overview](/docs/references/javascript/node). For how the bytes are laid out on disk, see [The .wvb bundle format](/docs/guide/core-concepts/webview-bundle).
