...
<Callout type="info">
  ...
  the `Remote` class from [`@wvb/node`](/docs/references/javascript/node).
</Callout>
...
<Callout type="info">
  ...
  string bytes — see [Remote bundles](/docs/guide/over-the-air) for how integrity and signatures fit
  together.
</Callout>
...
<Cards>
  <Card
    ...
    description="The full wvb command-line reference."
  />
  <Card
    title="The wvb.config file"
    href="/docs/references/configuration"
    description="defineConfig, pack, serve, and builtin options."
  />
  <Card
    title="Node API"
    href="/docs/references/javascript/node"
    description="The @wvb/node package — Bundle and Remote."
  />
</Cards>
