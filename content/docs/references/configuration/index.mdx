...
<Cards>
  <Card
    title="Remote, integrity & signature"
    href="/docs/references/configuration/remote"
    description="The remote section: endpoint, uploader/deployer, integrity hashing, and signing."
  />
  <Card
    title="CLI commands"
    href="/docs/references/cli"
    description="Every wvb command and how flags override config."
  />
  <Card
    title="Node API"
    href="/docs/references/javascript/node"
    description="The @wvb/node runtime that consumes the packed bundle."
  />
</Cards>
...
[Remote, integrity & signature](/docs/references/configuration/remote) page.
...
[`@wvb/node`](/docs/references/javascript/node).
...
as the remote section; see [Remote, integrity & signature](/docs/references/configuration/remote).
...
<Cards>
  <Card
    title="Remote, integrity & signature"
    href="/docs/references/configuration/remote"
    description="Configure the remote endpoint, uploader/deployer, integrity hashing, and signing."
  />
  <Card
    title="CLI commands"
    href="/docs/references/cli"
    description="Run pack, serve, upload, deploy, and builtin from the command line."
  />
  <Card
    title="Node API"
    href="/docs/references/javascript/node"
    description="Serve and verify bundles at runtime with @wvb/node."
  />
</Cards>
