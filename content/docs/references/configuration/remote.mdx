...
activates these bundles over the air — see [Remote bundles](/docs/guide/core-concepts/over-the-air).
...
<Callout type="info">
  ...
  but not JWK. See [Remote bundles](/docs/guide/core-concepts/over-the-air) for verification and the
  [Node API reference](/docs/references/javascript/node) for the client-side helpers.
</Callout>
