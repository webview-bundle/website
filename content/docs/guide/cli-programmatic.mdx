...
<Callout type="info">
  ...
  extension sniffing it uses on Node. Deno Desktop support is experimental; see the
  [Deno guide](/docs/guide/platforms/deno).
</Callout>

## Related

<Cards>
  <Card title="CLI commands" href="/docs/guide/cli" description="The full wvb command-line reference." />
  <Card title="The wvb.config file" href="/docs/config" description="defineConfig, pack, serve, and builtin options." />
  <Card title="Node API" href="/docs/references/node" description="The @wvb/node package — Bundle and Remote." />
</Cards>
