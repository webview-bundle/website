...
<Cards>
  ...
  <Card
    ...
    description="The full platform matrix and current status."
  />
  <Card
    title="Electron"
  ...
  <Card
    ...
    description="Serve a WKWebView from a bundle with the Swift bindings (iOS 16 minimum)."
  />
  <Card
    title="Deno Desktop"
    href="/docs/guide/platforms/deno"
    description="Run bundles in Deno Desktop."
  />
</Cards>
