...
<Callout type="warn">
  ...
  device-bearing `WebViewBundleFFI.xcframework` is installed. Develop against the iOS Simulator for
  now.
</Callout>
...
<Cards>
  ...
  <Card
    ...
    description="API references for the core and language bindings."
  />
</Cards>
