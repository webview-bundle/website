...
<Callout type="info">
  See [Platform support](/docs/guide/getting-started/platform-support) for the status of every
  platform.
</Callout>
...
For the remote HTTP contract, integrity, and signatures across platforms, see [Remote bundles](/docs/guide/over-the-air) and the guide to [building a remote](/docs/guide/remote).
