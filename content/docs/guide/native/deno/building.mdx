...
<Cards>
  <Card
    ...
    description="Serve and update .wvb bundles in a Deno Desktop webview."
  />
  <Card
    title="@wvb/deno-desktop"
    href="/docs/references/javascript/deno-desktop"
    description="Integration-layer API reference."
  />
  <Card
    title="@wvb/deno"
    href="/docs/references/javascript/deno"
    description="The native library, loadLib, and the install subcommand."
  />
</Cards>
