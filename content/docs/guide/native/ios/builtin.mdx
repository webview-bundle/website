...
<Cards>
  <Card
    ...
    description="Configure the package, register a scheme, and serve bundles in a WKWebView."
  />
  <Card
    title="wvb builtin"
    href="/docs/references/cli/builtin"
    description="Full flag reference for the builtin install command."
  />
  <Card
    title="Bundle sources"
    href="/docs/guide/core-concepts/bundle-source"
    description="How builtin and remote sources work together."
  />
</Cards>
