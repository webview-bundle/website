...
<Tabs items={['npm', 'pnpm', 'yarn']}>
  <Tab value="npm">
    ```sh npm install @wvb/remote-aws @wvb/remote-aws-provider @wvb/remote-aws-provider-pulumi ```
  </Tab>
  <Tab value="pnpm">
    ```sh pnpm add @wvb/remote-aws @wvb/remote-aws-provider @wvb/remote-aws-provider-pulumi ```
  </Tab>
  <Tab value="yarn">
    ```sh yarn add @wvb/remote-aws @wvb/remote-aws-provider @wvb/remote-aws-provider-pulumi ```
  </Tab>
</Tabs>
