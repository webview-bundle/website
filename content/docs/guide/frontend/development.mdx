...
<Cards>
  <Card
    ...
    description="Pack your built web assets into a .wvb bundle."
  />
  <Card
    title="Protocol handling"
    href="/docs/guide/core-concepts/protocol-handling"
    description="How the bundle and local schemes reach the webview."
  />
  <Card
    title="Upload"
    href="/docs/guide/frontend/upload"
    description="Push a packed bundle to your remote."
  />
</Cards>
