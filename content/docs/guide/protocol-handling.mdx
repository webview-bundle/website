...
<Callout type="warn">
  Android and iOS are pre-release and not yet published to Maven Central or tagged for SPM. Install
  from source for now.
</Callout>
...
<Cards>
  <Card
    ...
    description="How builtin and remote bundles resolve to the file a protocol serves."
  />
  <Card
    title="Platform integration"
    href="/docs/guide/platform-integration"
    description="How the core reaches each platform, plus the bridge."
  />
  <Card
    title="Electron"
    href="/docs/guide/platforms/electron"
    description="Register the bundle protocol in an Electron app."
  />
  <Card
    title="Tauri"
    href="/docs/guide/platforms/tauri"
    description="Register the bundle protocol with the wvb-tauri plugin."
  />
</Cards>
