...
**Integrity** is a hash over the *serialized bytes* of a bundle, so a client can confirm it
...
A **signature** proves *who* published a bundle, not just that it is intact. The publisher signs
