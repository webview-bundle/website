import { DOCS_URL, GITHUB_URL } from '@/components/home/data';
...
const en: UiStrings = {
  ...
  error: {
    ...
    message: 'An unexpected error occurred. The issue has been reported — please try again.',
    retry: 'Try again',
    home: 'Go home',
  },
};
...
const ko: UiStrings = {
  ...
  error: {
    title: '문제가 발생했습니다',
    message: '예기치 못한 오류가 발생했습니다. 문제가 접수되었으니 다시 시도해 주세요.',
    retry: '다시 시도',
    home: '홈으로',
  },
};
