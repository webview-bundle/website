...
// Full-screen error state, rendered by the route error boundaries (error.tsx).
// The locale is inferred from the path so the copy and links match the section
// the reader came from. `reset` re-attempts the failed render.
...
function ErrorScreenBody({ reset }: { reset?: () => void }) {
