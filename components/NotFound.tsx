...
// Global 404 page. Rendered by Next's `not-found.tsx`, so it catches both
// unmatched URLs and `notFound()` thrown from docs pages. The locale is inferred
// from the path (`/ko/...` → Korean) so the message and the nav links match the
// section the reader came from.
